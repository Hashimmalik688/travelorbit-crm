...
@if (session('success'))
  <div class="alert border-0 mb-3" style="background:rgba(22,163,74,.08);border-radius:12px;color:#15803D;font-size:.82rem;">
...
<div class="row g-3">
  <div class="col-lg-7">
    <div style="background:#fff;border-radius:18px;border:1px solid rgba(51,46,158,.08);padding:28px;box-shadow:0 2px 14px rgba(51,46,158,.05);">
        ...
        <div class="d-flex align-items-center gap-3 mb-4">
          ...
          <div class="flex-grow-1">
            ...
            <div class="d-flex align-items-center justify-content-between mt-1" style="gap:8px;">
              <span class="text-muted" style="font-size:.65rem;">JPG, PNG or WebP · max 2 MB</span>
              @if ($user->profile_photo_path)
                <label class="d-flex align-items-center gap-1 mb-0" style="font-size:.68rem;color:#DC2626;cursor:pointer;">
            ...
            @foreach ($roles as $val => [$label, $color])
              <div class="col-md-4">
                <label style="cursor:pointer;display:block;">
                  ...
                  <div class="role-card p-2 text-center" style="border-radius:10px;border:2px solid rgba(51,46,158,.10);transition:all .15s;font-size:.75rem;font-weight:600;color:{{ $color }};">
                    {{ $label }}
                  </div>
                </label>
              </div>
        ...
        <div class="p-3 mb-4" style="background:rgba(51,46,158,.03);border-radius:12px;border:1px solid rgba(51,46,158,.08);">
          <div class="fw-semibold mb-2" style="font-size:.75rem;color:#374151;">Reset Password <span class="text-muted fw-normal">(leave blank to keep current)</span></div>
          <div class="row g-2">
            <div class="col-md-6">
        ...
        <div class="p-3 mb-4" style="background:rgba(255,107,53,.04);border-radius:12px;border:1px solid rgba(255,107,53,.15);">
          <div class="fw-semibold mb-1" style="font-size:.75rem;color:#374151;">Stored Password <span class="text-muted fw-normal">(plain text — editable)</span></div>
          ...
          <div class="text-muted" style="font-size:.65rem;margin-top:3px;">
  ...
  <div class="col-lg-5">
    ...
    <div style="background:#fff;border-radius:16px;border:1px solid rgba(51,46,158,.08);overflow:hidden;margin-bottom:16px;">
      ...
      <div class="px-4 py-3">
        <div class="d-flex justify-content-between mb-2" style="font-size:.75rem;">
