    ...
    <div style="background:#fff;border-radius:18px;border:1px solid rgba(51,46,158,.08);padding:28px;box-shadow:0 2px 14px rgba(51,46,158,.05);">
        ...
        <div class="row g-3 mb-3">
          <div class="col-md-6">
            ...
            <input type="tel" name="phone" value="{{ old('phone', $user->phone) }}" placeholder="020 3932 3459"
          ...
          <div class="col-md-6">
            ...
            <input type="tel" name="whatsapp" value="{{ old('whatsapp', $user->whatsapp) }}" placeholder="07853 072479"
