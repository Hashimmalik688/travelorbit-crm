...
<div class="row g-3">
      ...
      <form method="POST" action="{{ route('settings.users.store') }}" enctype="multipart/form-data">
        ...
        <div class="d-flex align-items-center gap-3 mb-4">
          ...
          <div class="flex-grow-1">
            ...
            <div class="text-muted" style="font-size:0.78rem;margin-top:3px;">JPG, PNG or WebP · max 2 MB</div>
          </div>
        </div>
              ...
              <div class="col-md-4">
                <label style="cursor:pointer;display:block;">
                  ...
                  <div class="role-card p-3" style="border-radius:12px;border:2px solid rgba(51,46,158,.10);transition:all .15s;">
                    <div class="fw-semibold" style="font-size:0.936rem;color:{{ $color }};">{{ $label }}</div>
        ...
        <div class="row g-3 mb-4">
          <div class="col-md-6">
            <label class="form-label fw-semibold" style="font-size:0.864rem;color:#5A6080;">Password <span class="text-danger">*</span></label>
          ...
          <div class="col-md-6">
            <label class="form-label fw-semibold" style="font-size:0.864rem;color:#5A6080;">Confirm Password <span class="text-danger">*</span></label>
        ...
        <div class="d-flex gap-2">
          ...
          <a href="{{ route('settings.users.index') }}" class="btn fw-semibold"
            style="background:rgba(51,46,158,.07);color:#332E9E;border:none;border-radius:11px;padding:9px 18px;font-size:0.984rem;">
            Cancel
          </a>
        </div>
      </form>
  ...
  <div class="col-lg-5">
    <div style="background:rgba(51,46,158,.03);border-radius:16px;border:1px solid rgba(51,46,158,.08);padding:22px;">
      <h6 class="fw-bold mb-3" style="font-size:0.984rem;color:#0F172A;">How access works</h6>
      <div style="font-size:0.864rem;color:#475569;line-height:1.6;">
